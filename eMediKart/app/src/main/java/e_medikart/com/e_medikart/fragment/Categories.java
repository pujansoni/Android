...
public class Categories extends Fragment implements OkHttpInterface,SearchView.OnQueryTextListener{
                    ...
                    if(code == 1){
                        ...
                        if(jsonFetchAllCategory.has("manufacturer")){
                            ...
                            for(int i = 0; i < jsonArrayData.length(); i++){
                                ...
                                if(dataObject.has("manufacturer_description")){
                                    String mStrManufacturerDescription = String.valueOf(dataObject.getString("manufacturer_description"));
                                    Log.e(TAG, "manufacturer_description==" + mStrManufacturerDescription);
                                    categoriesModel.setManufacturer_description(mStrManufacturerDescription);
                                }

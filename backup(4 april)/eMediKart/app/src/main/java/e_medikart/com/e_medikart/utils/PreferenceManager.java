package e_medikart.com.e_medikart.utils;
...
public class PreferenceManager {
    ...
    public static void removeprefUserId(Context context, String str){
        mSharedPreferences = context.getSharedPreferences(SHAREDPREFERENCE, Context.MODE_PRIVATE);
        mSharedPreferences.edit().remove("str").commit();
    }
    public static void removeprefUserFirstName(Context context, String str){
        mSharedPreferences = context.getSharedPreferences(SHAREDPREFERENCE, Context.MODE_PRIVATE);
        mSharedPreferences.edit().remove("str").commit();
    }
    public static void removeprefUserLastName(Context context, String str){
        mSharedPreferences = context.getSharedPreferences(SHAREDPREFERENCE, Context.MODE_PRIVATE);
        mSharedPreferences.edit().remove("str").commit();
    }
    public static void removeprefUserEmail(Context context, String str){
        mSharedPreferences = context.getSharedPreferences(SHAREDPREFERENCE, Context.MODE_PRIVATE);
        mSharedPreferences.edit().remove("str").commit();
    }
    public static void removeprefUserCheckEmail(Context context, String str){
        mSharedPreferences = context.getSharedPreferences(SHAREDPREFERENCE, Context.MODE_PRIVATE);
        mSharedPreferences.edit().remove("str").commit();
    }
